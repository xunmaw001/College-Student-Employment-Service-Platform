...
public class FalvfaguiLiuyanView extends FalvfaguiLiuyanEntity implements Serializable {
	...
	public FalvfaguiLiuyanView() {

	}

	public FalvfaguiLiuyanView(FalvfaguiLiuyanEntity falvfaguiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, falvfaguiLiuyanEntity);
