...
public class FalvfaguiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FalvfaguiLiuyanEntity() {

	}

	public FalvfaguiLiuyanEntity(T t) {
		try {
     ...
     * 法律法规
     */
    @ColumnInfo(comment="法律法规",type="int(11)")
    ...
    @TableField(value = "falvfagui_liuyan_text")
    ...
    public String toString() {
        return "FalvfaguiLiuyan{" +
            ", id=" + id +
            ", falvfaguiId=" + falvfaguiId +
            ", yonghuId=" + yonghuId +
            ", falvfaguiLiuyanText=" + falvfaguiLiuyanText +
