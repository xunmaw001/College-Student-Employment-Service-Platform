        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xuanchuanContent"  label="宣传介绍" prop="xuanchuanContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xuanchuanContent" label="宣传介绍" prop="xuanchuanContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xuanchuanContent: [
                              { required: true, message: '宣传介绍不能为空', trigger: 'blur' },
                          ],
                   xuanchuanDelete: [
