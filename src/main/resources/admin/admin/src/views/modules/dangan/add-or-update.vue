    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生档案名称" prop="danganName">
                       <el-input v-model="ruleForm.danganName"
                                 placeholder="学生档案名称" clearable  :readonly="ro.danganName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学生档案名称" prop="danganName">
                           <el-input v-model="ruleForm.danganName"
                                     placeholder="学生档案名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生档案编号" prop="danganUuidNumber">
                       <el-input v-model="ruleForm.danganUuidNumber"
                                 placeholder="学生档案编号" clearable  :readonly="ro.danganUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学生档案编号" prop="danganUuidNumber">
                           <el-input v-model="ruleForm.danganUuidNumber"
                                     placeholder="学生档案编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.danganPhoto" label="学生档案照片" prop="danganPhoto">
                        <file-upload
                            tip="点击上传学生档案照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.danganPhoto" label="学生档案照片" prop="danganPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学生档案类型" prop="danganTypes">
                        <el-select v-model="ruleForm.danganTypes" :disabled="ro.danganTypes" placeholder="请选择学生档案类型">
                            <el-option
                                v-for="(item,index) in danganTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学生档案类型" prop="danganValue">
                        <el-input v-model="ruleForm.danganValue"
                            placeholder="学生档案类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="就业去向" prop="danganQuxiang">
                       <el-input v-model="ruleForm.danganQuxiang"
                                 placeholder="就业去向" clearable  :readonly="ro.danganQuxiang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="就业去向" prop="danganQuxiang">
                           <el-input v-model="ruleForm.danganQuxiang"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.danganContent"  label="学生档案介绍" prop="danganContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.danganContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.danganContent" label="学生档案介绍" prop="danganContent">
                            <span v-html="ruleForm.danganContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   danganName: [
                              { required: true, message: '学生档案名称不能为空', trigger: 'blur' },
                          ],
                   danganUuidNumber: [
                              { required: true, message: '学生档案编号不能为空', trigger: 'blur' },
                          ],
                   danganPhoto: [
                              { required: true, message: '学生档案照片不能为空', trigger: 'blur' },
                          ],
                   danganTypes: [
                              { required: true, message: '学生档案类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   danganContent: [
                              { required: true, message: '学生档案介绍不能为空', trigger: 'blur' },
                          ],
                   danganDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=dangan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.danganTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.danganContent = _this.ruleForm.danganContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.danganContent = this.ruleForm.danganContent.replaceAll(this.$base.url,"");
                        this.$http({
