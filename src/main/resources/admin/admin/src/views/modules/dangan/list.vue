        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '学生档案名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.danganName" placeholder="学生档案名称" clearable></el-input>
                     </el-form-item>
                         
                     <el-form-item :label="contents.inputTitle == 1 ? '学生档案类型' : ''">
                        <el-select v-model="searchForm.danganTypes" placeholder="请选择学生档案类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in danganTypesSelectSearch"
                               v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshengjiuyefuwupingtai/upload/danganMuBan.xls"
                        >批量导入学生档案数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('dangan','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.danganTypes!= '' && this.searchForm.danganTypes!= undefined) {
                    params['danganTypes'] = this.searchForm.danganTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=dangan_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.danganTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
