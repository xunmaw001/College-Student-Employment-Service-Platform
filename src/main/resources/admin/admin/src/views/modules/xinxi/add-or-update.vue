    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学生专业" prop="xinxiTypes">
                        <el-select v-model="ruleForm.xinxiTypes" :disabled="ro.xinxiTypes" placeholder="请选择学生专业">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学生专业" prop="xinxiValue">
                        <el-input v-model="ruleForm.xinxiValue"
                            placeholder="学生专业" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学生班级" prop="xinxiBanjiTypes">
                        <el-select v-model="ruleForm.xinxiBanjiTypes" :disabled="ro.xinxiBanjiTypes" placeholder="请选择学生班级">
                            <el-option
                                v-for="(item,index) in xinxiBanjiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学生班级" prop="xinxiBanjiValue">
                        <el-input v-model="ruleForm.xinxiBanjiValue"
                            placeholder="学生班级" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学院" prop="xinxiXueyuan">
                       <el-input v-model="ruleForm.xinxiXueyuan"
                                 placeholder="学院" clearable  :readonly="ro.xinxiXueyuan"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学院" prop="xinxiXueyuan">
                           <el-input v-model="ruleForm.xinxiXueyuan"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xinxiContent"  label="学生信息介绍" prop="xinxiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xinxiContent" label="学生信息介绍" prop="xinxiContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   xinxiContent: [
                              { required: true, message: '学生信息介绍不能为空', trigger: 'blur' },
                          ],
                   xinxiDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xinxi_banji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xinxiBanjiTypesOptions = data.data.list;
                    }
                });
